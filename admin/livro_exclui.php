...
if (isset($_GET['id_livro'])&& $_GET['id_livro'] !='') {
  $id= $_GET['id_livro'];
  $sqllivro = "SELECT id_livro, titulo FROM livros_tb WHERE id_livro=$id";
...
<div class="container-fluid">
  ...
  ?>
    ...
    <div class="col-md-12 col-lg-8">
        <h4 class="mb-3">Você confirma a exclusão do Livro: </h4>
        <form class="needs-validation" method="POST" action="" novalidate>
          <div class="row g-3">

            <div class="col-12">
              <label for="titulo" class="form-label">Título</label>
              <input type="text" class="form-control" id="titulo" name="titulo" value="<?php echo $linhalivro['titulo']?>" readonly>
          ...
          <hr class="my-4">
          <input type="hidden" name="excluir" value="exclui_livro">
