...
$sql = "SELECT * FROM categorias_tb ORDER BY id_categoria DESC";
...
if (isset($_GET['busca']) && $_GET['busca'] !='') {
  $busca = $_GET['busca'];
  $sql = "SELECT * FROM categorias_tb WHERE CONCAT(value,'',label) LIKE '%$busca%'";
  $resultado = mysqli_query($con,$sql);
  $linha = mysqli_fetch_assoc($resultado);
}
...
<div class="container-fluid">
  ...
  ?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <form class="d-flex w-100" action="categorias.php" method="GET">
 ...
 <?php if($linha > 0) {?>
    <h2>Categoria de Livros</h2>
      ...
      <?php } else {?>
        <p class="h4">Não existe nenhuma categoria <b><?php echo $busca?></b></p>
       <?php }?> 
    </main>
  </div>
</div>
